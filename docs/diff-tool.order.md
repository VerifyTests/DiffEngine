...
```
<sup><a href='/src/DiffEngine.Tests/DiffToolsTest.cs#L135-L137' title='Snippet source file'>snippet source</a> | <a href='#snippet-useorder' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
