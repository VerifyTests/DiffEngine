...
```
<sup><a href='/src/DiffEngine.Tests/DiffToolsTest.cs#L194-L198' title='Snippet source file'>snippet source</a> | <a href='#snippet-UseOrder' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
