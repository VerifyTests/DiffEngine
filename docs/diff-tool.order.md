...
```
<sup><a href='/src/DiffEngine.Tests/DiffToolsTest.cs#L141-L145' title='Snippet source file'>snippet source</a> | <a href='#snippet-UseOrder' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
