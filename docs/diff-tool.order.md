...
```
<sup><a href='/src/DiffEngine.Tests/DiffToolsTest.cs#L136-L140' title='Snippet source file'>snippet source</a> | <a href='#snippet-UseOrder' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
