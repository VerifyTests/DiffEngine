...
```
<sup><a href='/src/DiffEngine.Tests/DiffToolsTest.cs#L79-L90' title='Snippet source file'>snippet source</a> | <a href='#snippet-addtoolandlaunch' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
