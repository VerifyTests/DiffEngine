...
[![JetBrains logo.](https://raw.githubusercontent.com/VerifyTests/DiffEngine/main/docs/jetbrains.png)](https://jb.gg/OpenSourceSupport)<!-- endInclude -->
 ...
 * **[AraxisMerge](/docs/diff-tool.md#araxismerge)** Windows/OSX (Cost: Paid)<!-- include: diffToolList. path: /src/DiffEngine.Tests/diffToolList.include.md -->
 ...
 * **[WinMerge](/docs/diff-tool.md#winmerge)** Windows (Cost: Free with option to donate)<!-- endInclude -->
